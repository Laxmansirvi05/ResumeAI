...
- Prefer edge/static frontend plus Node backend for hosted ResumeAI.
...
**Audience:** Cloud hosted ResumeAI.
...
ResumeAI supports multiple deployment compositions from one codebase.
