...
export const env = createEnv({
	server: {
		...
		// AI Fallback Provider (optional)
		// If set, this key is used as a fallback when no user-configured AI provider exists.
		GOOGLE_GENERATIVE_AI_API_KEY: z.string().min(1).optional(),

		// Groq Fallback (optional)
		// Used as an immediate fallback when Gemini is rate-limited (429/quota).
